...
namespace BAR.TeamManager.WebApp.Models
{
    public sealed class IndexManager
    {
        ...
        public void AddQueue(int id, string title, string content)
        {
            ...
            viewModel.LuceneEnum = Model.EnumType.LuceneTypeEnum.Add;
        ...
        public void DeleteQueue(int id)
        {
            ViewModelContent viewModel = new ViewModelContent();
            viewModel.Id = id;
            viewModel.LuceneEnum = Model.EnumType.LuceneTypeEnum.Delete;
            queue.Enqueue(viewModel);
        }
        ...
        private void CreateIndexContent()
        {
            ...
            while (queue.Count > 0)
            {
                ...
                if (viewModel.LuceneEnum == Model.EnumType.LuceneTypeEnum.Delete)
                {
                    continue;
                }
